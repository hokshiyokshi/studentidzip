pipeline {
    ...
    environment {
        ...
        SONARQUBE_TOKEN = 'squ_dec580a4af7f85d26be40317533c23a80d34cc43'  // Set your new SonarQube token here
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                dir('workspace') {
                    git branch: 'main', url: 'https://github.com/hokshiyokshi/studentidzip1.git'
                }
            }
        }
