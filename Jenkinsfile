pipeline {
    ...
    environment {
        ...
        SONARQUBE_TOKEN = 'squ_2c8ee36015801264ce0ec5fe51c929ca293a571a'  // Set your new SonarQube token here
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                dir('workspace') {
                    git branch: 'main', url: 'https://github.com/hokshiyokshi/studentidzip.git'
                }
            }
        }
